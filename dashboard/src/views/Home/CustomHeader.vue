<template>
  <header class="header">
    <div class="flex flex-col w-4/5 max-w-6xl header-group">
      <div class="flex item-center justify-between py-10">
        ...
        <div class="flex">
          <button class="px-6 py-2 font-bold text-white focus:outline-none" @click="() => emit('create-account')">
            Crie uma conta
          </button>
...
@media(min-width: 640px) {
  .header-group {
    background-image: url(../../assets/images/balloons_blue.png);
